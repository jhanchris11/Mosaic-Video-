...
function sendemail(urlS3) {
    return new Promise((response, reject) => {
        ...
        let mailDetails = {
            from: user, // Correo remitente :D
            to: 'ferbj200@gmail.com', // lista de destinatarios
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
                                  <tr>
                                    <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                      <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="https://bucket000upload.s3.amazonaws.com/mosaico2.webm
" target="_blank">Video</a>
        ...
        emailOption.sendMail(mailDetails, function (err, data) {
            if (err) {
